...
print(f'''\033[2;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  \033[1;33m[⌯]\033[1;31mDEVELOPER    :  KENZO
  \033[1;33m[⌯]\033[1;34mPY KENZO     :  @K_N_Z_O
  \033[1;33m[⌯]\033[2;36mTOOLS PYTHON :  TOOL FACEBOOK
 \033[1;33m [⌯]\033[2;32mTELEGRAM     :  @K_N_Z_O
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [KENZO 🇮🇶 ] %s/%s ➙ [ [𝗢𝗞]] %s ➙ [ [𝗖𝗣]] %s ..  %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
بـالــعـافـية ♥🔥 [ @K_N_Z_O ]

☫─────━الـ ڪــيـنزو 🔥━─────☫

  @K_N_Z_O  -  VIP		'''
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='cyan'))
