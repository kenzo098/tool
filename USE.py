...
def menu(my_name,my_id):
	...
	g67 = '\x1b[38;5;14m'
	print(g67+'_'*67)
	print('\n   \033[0m\033[1;93m [\033[1;92m\033[1;44m  𝐓𝐇𝐄 𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑 • channel @N_9_N_6    \033[0m\033[1;93m]\n')
	print('  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}\x1b[38;5;133m 𝑇𝐸l𝐸 \x1b[38;5;230m ⁞ \x1b[38;5;153mKENZO')
	print('\x1b[38;5;230m')
	print('')
	print(g67+'━'*67)
...
def setting():
	...
	print('')
	_jembot_ = input('>> Add App : اظهار التطبيقات المرتبطه ( Y/N ) ')
	if _jembot_ in ['']:
		...
		taplikasi.append('no')
	pwplus=input('>> Password Manual : باسورد يدوي (N عشوائي)( Y/N ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s\033[2;35m %s/%s ➙ [ [ OK ] ] %s ➙ [ [ CP ] ] %s .. %s%s%s  '%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
