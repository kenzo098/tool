...
import datetime;now = datetime.date.today();target = datetime.date(2024, 11, 4)
...
def menu(my_name,my_id):
	...
	print('  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}\x1b[38;5;133m 𝑇𝐸l𝐸 \x1b[38;5;230m ⁞ \x1b[38;5;153m@K_N_Z_O')
	print('\x1b[38;5;230m')
	print('')
	print(g67+'━'*67)
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [KENZO 🇮🇶 ] %s/%s ➙ [ [OK] ] %s ➙ [ [CP] ] %s ..  %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
